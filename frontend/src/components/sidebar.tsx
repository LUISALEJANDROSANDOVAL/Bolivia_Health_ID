      ...
      >
        ...
        <div className="mx-4 mt-6 rounded-2xl bg-white/5 p-4 backdrop-blur-sm border border-white/10">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs text-white/50 uppercase tracking-widest font-bold">Salud General</p>
              <p className="text-2xl font-black text-white">92%</p>
            </div>
            <Activity className="size-8 text-white/20" />
          </div>
          <div className="mt-3 h-1.5 rounded-full bg-white/10">
            <div className="h-1.5 w-[92%] rounded-full bg-gradient-electric shadow-lg shadow-cyan-500/20" />
          </div>
        </div>
        ...
        <div className="m-4 rounded-2xl bg-white/5 p-4 backdrop-blur-sm border border-white/10">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <p className="text-sm font-black text-white tracking-tight uppercase text-[10px]">Protección Activa</p>
              <p className="text-xs text-white/40 font-medium">Cifrado End-to-End</p>
            </div>
            <Sparkles className="size-4 text-cyan-400 group-hover:scale-110 transition-all animate-pulse" />
          </div>
        </div>
      </aside>
    </>
