      ...
      <CardHeader className="border-b border-border bg-gradient-to-r from-gray-50/50 to-white p-6">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <CardTitle className="text-xl font-semibold text-azul-profundo">
          ...
          {uploadedFiles.length > 0 && (
            <div className="text-right">
              ...
              <p className="text-sm font-semibold text-azul-electrico">
      ...
      <CardContent className="p-6 space-y-6">
        ...
        >
          <input
            ...
            className="hidden"
          />
          <div className="flex size-16 items-center justify-center rounded-full bg-gradient-electric bg-opacity-10">
            <Cloud className="size-8 text-azul-electrico" />
          </div>
          <div className="mt-4 text-center">
            <p className="text-base font-medium text-azul-profundo">
        ...
        {uploadedFiles.length > 0 && (
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <h4 className="text-sm font-medium text-azul-profundo flex items-center gap-2">
                <HardDrive className="size-4 text-azul-electrico" />
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-2">
                        <div className="flex-1">
                          <p className="font-medium text-azul-profundo truncate">
                            {file.name}
                          </p>
